...
class WebfingerClient:
    ...
    async def get_actor_id(self, wf):
        ...
        headers = {
            "User-Agent": "crawler.pub/0.14.0 (https://crawler.pub/; evanp@gatech.edu)",
    ...
    def _normalize(self, wf):
        ...
        if wf[0] == "@":
            ...
            full = wf
        username, hostname = full.split("@")
        decoded = idna.encode(hostname, uts46=True).decode("ascii")
        return f"acct:{username}@{decoded}"
