...
- survey_hosts.py clears old properties when a host is re-surveyed.

## [0.16.1] - 2026-07-30

### Fixed

- Let NodeinfoClient use its default transport, including retries default
...
- Moved host_* methods from DatabaseGraph to new DatabaseHostSurvey class
...
- Inline items in collections are treated as completed page chains.
...
- Webfinger, ActivityPub clients timeout after 30 seconds
- Better error reporting in crawler worker
...
- fixup script for new dispatching

## [0.9.2] - 2026-07-14

### Updated

- Reduce burst processing to smooth out requests
- Remove job skimming
...
- Need the private key pem in recover_failed.py

## [0.9.0] - 2026-07-13

### Added

- bin/recover_failed.py script to reenqueue failed jobs that probably should
...
- snapshot is robust to out-of-range and poorly-formatted follower and following counts.
...
[Unreleased]: https://github.com/pub-crawler/pub-crawler/compare/v0.16.2...HEAD
...
[0.9.1]: https://github.com/pub-crawler/pub-crawler/compare/v0.9.0...v0.9.1
[0.9.0]: https://github.com/pub-crawler/pub-crawler/compare/v0.8.3...v0.9.0
